# EBANX Payment Gateway for Magento 1.9.x [![Build Status](https://travis-ci.org/ebanx/magento-gateway-ebanx.svg?branch=master)](https://travis-ci.org/ebanx/magento-gateway-ebanx)
