# EBANX Payment Gateway for Magento 1.9.x [![Build Status](https://api.travis-ci.org/ebanx/magento-gateway-ebanx.svg)](https://travis-ci.org/ebanx/mageto-gateway-ebanx)
